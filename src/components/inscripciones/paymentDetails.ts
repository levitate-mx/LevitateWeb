export const registrationPaymentConsultationPath = "/inscripciones/consulta-curp";

export const registrationPaymentMethodSections = [
  {
    id: "banamex",
    title: "Banamex",
    rows: [
...
export const registrationPaymentConceptLabel = "Concepto";
